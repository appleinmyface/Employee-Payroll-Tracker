...
const collectEmployees = function () {
  ...
  while (addMore) {
    var firstName = prompt("Input the Employee's First Name");
    console.log(`First Name Entered: ${firstName}`);

    var lastName = prompt("Input the Employee's Last Name");
    console.log(`Last Name Entered: ${lastName}`);

    var salaryInput = prompt("Input the Employee's Salary");
    console.log(`Salary Entered: ${salaryInput}`);
...
const displayAverageSalary = function (employeesArray) {
  ...
  console.log(`The Average Employee Salary among our ${employeesArray.length} employee(s) is 
